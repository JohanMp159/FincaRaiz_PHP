    ...
    if($enviar=="Enviar")
        {
            ...
            $sqlguardar="SELECT nombre FROM AguaClara WHERE nombre = '$nombre' ORDER BY nombre";
            ...
            if($result=mysqli_query($MySQLiconexion,$sqlguardar))
            {
                ...
                if($nroregistros > 0)
                {
                    ...
                    $guardado = $MySQLiconexion->query("insert into AguaClara(nombre,codigo,telefono,Val_Inicial,Val_Restante,Fecha_Ingreso,Fecha_Retiro) values ('$nombre','$codigo','$telefono','$Vinicial','$Vrest','$FIng','$FRet')");
                    if(!$guardado)
                    {
...
<body>
	...
	<nav class="main-nav">
		<div class="container container--flex">	
			...
			<ul class="menu" id="menu">
				...
				<li class="menu__item"> <a href="AguaClara.php" class="menu__link menu__link--select">Finca Agua Clara</a></li>
	...
	<section class="banner" class="container--flex">
		<img src="Images/Finc7.jpg" alt ="" class="banner__img">
		<div class="banner__content" >
           <div>
           <h2>AguaClara</h2>
           <h6>$2'200.000</h6><br>
            <h4>El espacio más lujoso en  <br>
            el departamento de Antioquia. </h4>
           </div>
            <img src="Images/Finc1.jpg" alt ="" class="img_cuad" height="170px;" width="200px" >
            <img src="Images/Finc8.jpg" alt ="" class="img_cuad" height="170px;" width="200px" >
            <img src="Images/Finc10.jpg" alt ="" class="img_cuad" height="170px;" width="200px" >
            <img src="Images/Finc9.jpg" alt ="" class="img_cuad" height="170px;" width="200px" >
        </div>
    </section>
