...
if(isset($_POST['Enviar'])){
    if(!$enviar){
        ...
        if($enviar=="Enviar")
        {
            ...
            $sqlguardar="SELECT nombre FROM VillaMaria WHERE nombre = '$nombre' ORDER BY nombre";
            ...
            if($result=mysqli_query($MySQLiconexion,$sqlguardar))
            {
                ...
                if($nroregistros > 0)
                {
                    ...
                    $guardado = $MySQLiconexion->query("insert into VillaMaria(nombre,codigo,telefono,Val_Inicial,Val_Restante,Fecha_Ingreso,Fecha_Retiro) values ('$nombre','$codigo','$telefono','$Vinicial','$Vrest','$FIng','$FRet')");
                    if(!$guardado)
                    {
...
<body>
	...
	<nav class="main-nav">
		<div class="container container--flex">	
			...
			<ul class="menu" id="menu">
				...
				<li class="menu__item menu__link--select"> <a href="VillaMaria.php" class="menu__link">Finca Villa Maria</a></li>
				<li class="menu__item"> <a href="AguaClara.php" class="menu__link">Finca Agua Clara</a></li>
				<li class="menu__item"> <a href="FincaBosques.php" class="menu__link">Finca Bosques</a></li>
	...
	<section class="banner" class="container--flex">
		<img src="Images/Finc11.jpg" alt ="" class="banner__img">
		<div class="banner__content" >
           <div>
           <h2>VillaMaria</h2> 
           <h6>$1'200.000</h6><br>
            <h4>El espacio más verde en  <br>
            el departamento de Antioquia. </h4>
           </div>
            <img src="Images/Finc15.jpg" alt ="" class="img_cuad" height="170px;" width="200px" >
            <img src="Images/Finc12.jpg" alt ="" class="img_cuad" height="170px;" width="200px" >
            <img src="Images/Finc13.jpg" alt ="" class="img_cuad" height="170px;" width="200px" >
            <img src="Images/Finc14.jpg" alt ="" class="img_cuad" height="170px;" width="200px" >
        </div>
    </section>
